...
public class RegisterPageTest {
  ...
  public void registerPage() {
    ...
    driver.findElement(By.id("FirstName")).sendKeys("Nenad");
    driver.findElement(By.id("LastName")).click();
    driver.findElement(By.id("LastName")).sendKeys("Perisic");
    driver.findElement(By.id("Email")).click();
    driver.findElement(By.id("Email")).sendKeys("nesoperiso@gmail.com");
    driver.findElement(By.id("CreatePassword")).click();
    driver.findElement(By.id("CreatePassword")).sendKeys("NenadPerisic");
