	 ...
	 private String
	  ...
	  public void addToCart() {
		...
		driver.findElement(By.className("add-to-cart")).click();
		  ...
		  double suma = 0;
		    String cena1 =  driver.findElements(By.className("ajaxcart__price")).get(0).getText().replace("€", "").replace(",", ".");
		    suma+= Double.parseDouble(cena1);
		    System.out.println(cena1);
		   String cena2 = driver.findElements(By.className("ajaxcart__price")).get(1).getText().replace("€", "").replace(",", ".");
		    suma+= Double.parseDouble(cena2);
		    System.out.println(cena2);
		   String cena3 = driver.findElements(By.className("ajaxcart__price")).get(2).getText().replace("€", "").replace(",", ".");
		    suma+= Double.parseDouble(cena3);
		    System.out.println(cena3);
		    String u = driver.findElement(By.className("cart-total-price")).getText().replace("€", "").replace(",", ".");
